  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md my-auto">
        <div className="bg-slate-950/70 backdrop-blur-2xl border border-white/15 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/80 text-white">
          ...
          <div className="mt-6 pt-4 border-t border-white/10 text-center">
            <p className="text-xs text-slate-400">
              ...
              <Link to="/login" className="text-rose-300 hover:text-rose-200 font-semibold transition-colors">
                Sign In
              </Link>
            </p>
          </div>
